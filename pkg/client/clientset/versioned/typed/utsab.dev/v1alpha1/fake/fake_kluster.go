...
type FakeKlusters struct {
	Fake *FakeUtsabV1alpha1
	ns   string
}

var klustersResource = schema.GroupVersionResource{Group: "utsab.dev", Version: "v1alpha1", Resource: "klusters"}

var klustersKind = schema.GroupVersionKind{Group: "utsab.dev", Version: "v1alpha1", Kind: "Kluster"}
